...
## Updating your version of git on SuperMike2

To run a more recent version of git (2.17.0) on SuperMike2, please run the following lines in your Terminal after logging in to OnDemand:
...
The version number should now be 2.17.0.
